...
Without Te Range Parameters - Automatically Determined
...
Te search range is automatically determined - no user input required.
"""
...
def determine_te_range(topography, moho_depth, dx, dy):
    """
    Automatically determine Te search range based on data characteristics
    Uses a reasonable default range for Mars lithosphere
    ...
    --------
    Te_range : tuple
        (Te_min, Te_max) in meters
    """
    # Default range for Mars: 1-100 km (1000-100000 m)
    # This covers typical elastic thickness values for planetary lithospheres
    Te_min = 1000   # 1 km minimum
    Te_max = 100000  # 100 km maximum
